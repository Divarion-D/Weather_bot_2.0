class Language:
    ...
    ABOUT_MESSAGE = (
        'Автор Бота: https://t.me/Divarion_D\n'
        + 'GitHub: https://github.com/Divarion-D\n'
    )
    ...
    SET_CITY = (
        'Введите название города и страну в формате: город, страна\n'
        + 'Например: London, US\n'
    )
    ...
    ADD_CHANNEL = (
        'Добавьте меня в канал\n'
        + 'После чего перешлите мне сообщение из этого канала'
    )
